...
{
    /// <summary>
    /// This class is responsible for controlling the player character's movement speed based on input from the head and hands.
    /// It uses a combination of head and hand input to determine whether the player is walking or running, and adjusts the speed accordingly.
    /// </summary>
