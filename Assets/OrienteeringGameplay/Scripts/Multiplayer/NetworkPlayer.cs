    ...
    public class NetworkPlayer : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (photonView.IsMine)
            {
                ...
                {
                    leaderboardManager.currentPlayerNickName = photonView.Owner.NickName;//other option is playerprefs.getstring...
                    leaderboardManager.currentPlayerUserId = photonView.Owner.UserId;
                }
            }
