    ...
    public class ScreenFader : MonoBehaviour
    {
        ...
        protected virtual void Initialize()
        {
            ...
            if (fadeObject == null)
            {
                ...
                fadeObjectRect.anchorMin = new Vector2(0, 0);
                fadeObjectRect.anchorMax = new Vector2(1, 1);
                fadeObjectRect.pivot = new Vector2(0.5f, 0.5f);
                fadeObjectRect.sizeDelta = Vector2.zero;
                fadeObjectRect.localScale = new Vector2(1f, 1f);
            }
        }
        ...
        protected virtual void updateImageAlpha(float alphaValue)
        {
            ...
            if (Mathf.Approximately(alphaValue, 0) && canvasGroup.gameObject.activeSelf)
            {
